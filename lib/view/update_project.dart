...
class Update_project extends StatelessWidget{

  Update_project_controller update_controller = Get.put(Update_project_controller());

  @override
  Widget build(BuildContext context) {

    update_controller.set_date();
    TextEditingController task_name = TextEditingController(text: update_controller.project_name);
